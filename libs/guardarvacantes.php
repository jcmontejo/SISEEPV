...
try {
	...
	if ($require_position == "" || $task == "" || $habilities == "" || $area == "" || $salary == "" || $contact == "" ) {
			# code...
			...
			$sql = "INSERT INTO vacancy_request (require_position,task,habilities,area,salary,contact,company_id) 
			VALUES ('$require_position', '$task', '$habilities', '$area', '$salary', '$contact', $company_id)";
