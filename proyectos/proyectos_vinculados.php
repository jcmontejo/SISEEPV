...
<body>
    ...
    <div class="row">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h2 class="page-header"><span class="label label-danger"> Lineas de investigación</span></h2>                
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            <div class="col-md-3 img-portfolio">
                <a href="portfolio-item.html">
                    <img class="img-responsive img-hover" src="../images/image_database.jpg" alt="">
                </a>
                <h3>
            ...
            <div class="col-md-3 img-portfolio">
                <a href="portfolio-item.html">
                    <img class="img-responsive img-hover" src="images/image_inteligence_art.jpg" alt="">
                </a>
                <h3>
            ...
            <div class="col-md-3 img-portfolio">
                <a href="portfolio-item.html">
                    <img class="img-responsive img-hover" src="images/image_computing.jpg" alt="">
                </a>
                <h3>
            ...
            <div class="col-md-3 img-portfolio">
                <a href="portfolio-item.html">
                    <img class="img-responsive img-hover" src="images/image_architec_computer.jpg" alt="">
                </a>
                <h3>
                    <a>Arquitectura de Computo</a>
                </h3>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <ul class="list-unstyled">
                                <li><a href="../proyectos/jerarquia.php">Organización Jerárquica</a>
                                </li>                                
                                <li><a href="../proyectos/docentes.php">Cuerpo Académico</a>
                                </li>                                
                                <li><a href="../proyectos/proyectos.php">Proyectos de Investigación</a>
                                </li>                                
                            </ul>
                        </div>
                    </div>
