    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4 img-portfolio">                
                ...
                <h3>
                    <a>M.C. Jose Alberto Morales Mancilla</a>
                </h3>
                <p>Docente de tiempo completo.</p>
                <p>amancilla58@hotmail.com</p>                
        ...
        <div class="row">
            ...
            <div class="col-md-4 img-portfolio">                
                ...
                <h3>
                    <a>M.C Octavio Ariosto Ríos Tercero</a>
                </h3>
                <p>Docente de tiempo completo.</p>
                <p>oarios_oarios@yahoo.com.mx</p>
            </div>
            <div class="col-md-4 img-portfolio">                
                    <img class="img-responsive img-hover" src="../images/user.jpg" alt="">
                </a>
        ...
        <div class="row">
            ...
            <div class="col-md-4 img-portfolio">                
                ...
                <p>Docente de tres cuartos de tiempo.</p>
                <p>magutz_03@hotmail.com</p>
            </div>
            <div class="col-md-4 img-portfolio">                
                    <img class="img-responsive img-hover" src="../images/user.jpg" alt="">
                </a>
        ...
        <div class="row">
            <div class="col-md-4 img-portfolio">                
                ...
                <p>Docente de asignatura.</p>
                <p>mgmonjaras@hotmail.com</p>
            </div>
            <div class="col-md-4 img-portfolio">                
                    <img class="img-responsive img-hover" src="../images/user.jpg" alt="">
                </a>
        ...
        <div class="row">
            <div class="col-md-4 img-portfolio">                
                ...
                <p>Docente de tres caurtos de tiempo.</p>
                <p>agonzalezl@ittg.edu.mx</p>
            </div>
            <div class="col-md-4 img-portfolio">                
                    <img class="img-responsive img-hover" src="../images/user.jpg" alt="">
                </a>
                ...
                <p>Docente de medio tiempo.</p>
                <p>ingrparedes@yahoo.com.mx</p>
            </div>
            <div class="col-md-4 img-portfolio">                
                    <img class="img-responsive img-hover" src="../images/user.jpg" alt="">
                </a>
