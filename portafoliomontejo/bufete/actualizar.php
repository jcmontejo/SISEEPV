...
<body>
    ...
    if (isset($_GET['mensaje']) && $_GET['mensaje'] == 1) {
        ...
        echo '<div class="alert alert-success">
                    <strong>En horabuena!</strong> se ha actualizado exitosamente.
                </div>';
    }
 ...
 ?>
                        ...
                        <form role="form" action="cargar2.php" method="POST" enctype="multipart/form-data">

                            <div class="form-group">
                                <label>ID de archivo a modificar</label>
                            ...
                            <button type="submit" class="btn btn-default" name="guardar">Actualizar</button>
