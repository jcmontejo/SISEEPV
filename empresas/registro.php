...
<head>
    ...
    <title>Registro de Empresa | SISEEPV</title>
...
<body>
    ...
    <hr>
     <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    <li><a >Para hacer uso de los servicios necesitas registrar tu Empresa.</a>
                    </li>
                 </ol>   
    ...
    <div class="row">
        ...
        <form action="../libs/guardarregistro.php" method="POST">
            <div class="form-group">
                <label for="">Nombre</label>
                <input type="text" name="company_name" placeholder="ingresar nombre de la empresa" class="form-control">
            </div>
            <div class="form-gropu">
                <label for="">Sector</label>
                <input type="text" name="sector" placeholder="ingresar sector de la empresa" class="form-control">
            </div><br>
            <div class="form-group">
                <label for="">Dirección</label>
                <input type="text" name="home"placeholder="ingresar dirección de la empresa"class="form-control">
            </div>
            <div class="form-gropu">
                <label for="">Teléfono</label>
                <input type="text" name="phone" placeholder="ingresar telefono de la empresa" class="form-control">
            </div><br>
            <div class="form-gropu">
                <label for="">Director</label>
                <input type="text" name="director_name" placeholder="ingresar nombre del director de la empresa" class="form-control">
            </div><br>
            <div class="form-gropu">
                <label for="">Contacto con ITTG</label>
                <input type="text" name="link_with_ittg" placeholder="ingresar nombre del vinculo con el ITTG" class="form-control">
