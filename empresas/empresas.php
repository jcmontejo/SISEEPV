...
<body>
    ...
    <div class="row">
        <div class="col-md-8">
         <div class="col-md-8">
                <h2>Seguimiento a Empresas</h2><br>
            ...
            <div class="col-md-4">
                <div class="media">
                    ...
                    <div class="media-body">
                        ...
                        <p align="justify">Realiza solicitudes de empleo, residencias profesionales y servicio social para tu empresa.</p>
                    </div>
                </div>
                <div class="media">
                    <div class="pull-left">
                    ...
                    <div class="media-body">
                        ...
                        <p align="justify">Efectividad con los vinculos de la institución con las Empresas.</p>
                    </div>
                </div>
            </div>
        </div>
        <!-- /.row -->
            ...
            <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <ul class="list-unstyled">
                                <li><a href="../empresas/registro.php">Registro de Empresa</a>
                                </li>
                                <li><a href="../empresas/bolsa.php">Bolsa de trabajo</a>
                                </li>
                                <li><a href="../empresas/vacantes.php">Solicitud de Vacantes</a>
                                </li>
                                <li><a href="../empresas/residentes.php">Solicitud de Residentes</a>
                                </li>
                                <li><a href="../empresas/servicio.php">Solicitud Servicio Social</a>
                                </li>
                ...
                <div class="well">
                    ...
                    <p align="justify">El Instituto Tecnologico de Tuxtla Gutiérrez, es una institución interesada en mantener el vinculo de identidad contigo.
