...
<head>
    ...
    <title>Solicitud de Vacantes | SISEEPV</title>
    ...
    <div class="row">
        <div class="col-md-8">
         <div class="item form-group">
                <h3>Solicitud de Vacante</h3>
                
        </div>

        <div class="x_content">

        <form action="../libs/guardarvacantes.php" method="POST">
            <div class="form-group">
                <label for="">Puesto Requerido</label>
                <input type="text" name="require_position" placeholder="ingresar puesto a solicitar" class="form-control">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="habilities" placeholder="ingresar habilidades"class="form-control">
            </div>
            <div class="form-gropu">
            ...
            <div class="form-gropu">
                ...
                <input type="text" name="salary" placeholder="ingresar salario" class="form-control">
            </div><br>
            <div class="form-gropu">
