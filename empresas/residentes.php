...
<head>
    ...
    <title>Solicitud de Residentes | SISEEPV</title>
    ...
    <div class="row">
        <div class="col-md-8">
         <div class="item form-group">
                <h3>Solicitud de Residentes</h3>
                
        </div>

        <div class="x_content">

        <form action="../libs/guardarresidentes.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="home" placeholder="ingresar direccion de la empresa" class="form-control">
            </div>
            <div class="form-gropu">
