...
<head>
    ...
    <title>Editar datos de Empresa | SISEEPV</title>
...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/siseepv/empresas/home.php">SISEEPV</a>
            </div>
    ...
    <div class="row">
        ...
        <form action="../libs/guardareditar.php">
            <div class="form-group">
                <label for="">Nombre</label>
                <input type="text" name="name" placeholder="ingresar nombre de la empresa" class="form-control">
            </div>
            ...
            <div class="form-gropu">
                ...
                <input type="text" name="director" placeholder="ingresar nombre del director de la empresa" class="form-control">
            </div><br>
            <div class="form-gropu">
                <label for="">Contacto con ITTG</label>
                <input type="text" name="contact" placeholder="ingresar nombre del vinculo con el ITTG" class="form-control">
