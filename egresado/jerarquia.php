...
<body>
    ...
    <!-- Page Heading/Breadcrumbs -->
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Organización Jerárquica</h1>                
            </div>
        </div>
        <!-- /.row -->
        <!-- Projects Row -->
        <div class="row">
            ...
            <div class="col-md-4 img-portfolio">                
                ...
                <h4>M.C Franciso suarez Ruiz</h4>
            </div>
            <div class="col-md-4 img-portfolio">                
                    <img class="img-responsive img-hover" src="" alt="">
                </a>
        ...
        <div class="row">
            <div class="col-md-4 img-portfolio">                
              <img class="img-responsive img-hover" src="../images/user.jpg" alt="">                
                <h3>Jefe de Oficina de Proyectos</h3>
                <h4>Dr. Héctor Guerra Crespo.</h4>
            </div>
            <div class="col-md-4 img-portfolio">                
                    <img class="img-responsive img-hover" src="../images/user.jpg" alt="">
                </a>
                <h3>Jefe de Oficina de Proyectos de Investigación</h3>
                <h4>M.C. Octavio Ariosto Ríos Tercero</h4>
            </div>
            <div class="col-md-4 img-portfolio">                
                    <img class="img-responsive img-hover" src="../images/user.jpg" alt="">
                </a>
                <h3>Jefe de Oficina de Proyectos de Vinculación</h3>
                <h4>M.C Aída Guillermina Cossio Martinez</h4>
            </div>
        </div>
