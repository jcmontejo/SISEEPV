...
<body>
    ...
    <div class="container">
        ...
        <!-- /.row -->
        <form action="../libs/guardarestudiosdata.php" method="POST">
            <div class="col-md-8">
                <div class="form-group">
                    <label>fecha de ingreso:</label>
                    <input type="date" class="form-control" name="admision_day" placeholder="Ingresa tú fecha de ingreso">
                </div>
            </div>
            <div class="col-md-8">
                <div class="form-group">
                    <label>fecha de egreso:</label>
                    <input type="date" class="form-control" name="exit_day" placeholder="Ingresa tus apellidos">
                </div>
            </div>
            <div class="col-md-8">
                <div class="form-group">
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="day_certification" placeholder="Ingresa la dirección de tú domicilio">
                    <input type="hidden" name="user_id" value="<?php echo $_SESSION['idegresado'];?>">
                </div>
            </div>
            <div class="col-md-8">
                <div class="form-group">
                    <label>Metodo de titulación:</label>
                   <select name="certification_method" class="form-control">
                        <option>Residencia Profesional</option>
                        <option>Tesis</option>
                        <option>Ceneval</option>
                    </select>
                </div>
            </div>
             <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="average" placeholder="Ingresa promedio">
                </div>
            </div>
             <div class="col-md-8">
                <div class="form-group">
                    <label>Ultimo grado de estudios:</label>
                    <input type="text" class="form-control" name="last_grade_student" placeholder="Ingresa ultimo grado de estudios">
                </div>
            </div>
             <div class="col-md-8">
                <div class="form-group">
                    <label>Institución de ultimo grado de estudios:</label>
                    <input type="text" class="form-control" name="graduate_institution_name" placeholder="Ingresa nombre de institución">
                </div>
            </div>
            <div class="col-md-8">
            ...
            <div class="col-md-8">
                <?php 
                    ...
                    if (isset($_GET['mensaje']) && $_GET['mensaje'] == '2') {
                                    echo '<div class="alert alert-danger">
                                                <strong>Algo esta mal!</strong> ya has llenado tus datos académicos.
                                            </div>';
                                }
                    if (isset($_GET['mensaje']) && $_GET['mensaje'] == '3') {
                                    echo '<div class="alert alert-success">
                                                <strong>Muy bien!</strong> has guardado tus datos académicos exitosamente.
                                            </div>';
                                }
