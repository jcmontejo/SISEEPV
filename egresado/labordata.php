...
<body>
    ...
    <div class="container">
        ...
        <!-- /.row -->
        <form action="../libs/guardarlabordata.php" method="POST">
            <div class="col-md-8">
                <div class="form-group">
                    <label>Nombre de empresa:</label>
                    <input type="text" class="form-control" name="name_company" placeholder="Ingresa empresa">
                </div>
            </div>
            <div class="col-md-8">
                <div class="form-group">
                    <label>Domicilio de empresa:</label>
                    <input type="text" class="form-control" name="home_company" placeholder="Ingresa domicilio">
                </div>
            </div>
            <div class="col-md-8">
                <div class="form-group">
                    <label>Telefono de empresa:</label>
                    <input type="text" class="form-control" name="phone_company" placeholder="Ingresa telefono">
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="current_position" placeholder="Ingresa puesto ocupado">
                </div>
            </div>
            <div class="col-md-8">
                <div class="form-group">
                    <label>Area de trabajo:</label>
                    <input type="text" class="form-control" name="work_area" placeholder="Ingresa tu area de trabajo">
                </div>
            </div>
             <div class="col-md-8">
                <div class="form-group">
                    <label>Salario percibido:</label>
                    <select name="salary" id="" class="form-control">
                        <option value="s1">$4000 - $8000</option>
                        <option value="s2">$8000 - $12000</option>
                        <option value="s3">$12000 - $16000</option>
                        <option value="s4">$16000 - $20000</option>
                    </select>
                    <!--<input type="text" class="form-control" name="salary" placeholder="Ingresa salario">-->
                </div>
            </div>
            <div class="col-md-8">
            ...
            <div class="col-md-8">
                <?php 
                    ...
                    if (isset($_GET['mensaje']) && $_GET['mensaje'] == '2') {
                                    echo '<div class="alert alert-danger">
                                                <strong>Algo esta mal!</strong> ya has llenado tus datos laborales.
                                            </div>';
                                }
                    if (isset($_GET['mensaje']) && $_GET['mensaje'] == '3') {
                                    echo '<div class="alert alert-success">
                                                <strong>Muy bien!</strong> has guardado tus datos personales exitosamente.
                                            </div>';
                                }
