...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h2 class="page-header">Solicita una cita 
                    <small>para atenderte mejor</small>
                </h2>
            </div>
        </div>
        <!-- /.row -->
        <form action="../libs/guardarcita.php" method="POST">
            <div class="col-md-8">
                <div class="form-group">
                    <label>Nombre:</label>
                    <input type="text" name="name" class="form-control" placeholder="Introduce tú nombre">
                </div>
            </div>
            <div class="col-md-8">
                <div class="form-group">
                    <label>Correo:</label>
                    <input type="email" name="email" class="form-control" placeholder="Introduce tú correo">
            ...
            <div class="col-md-8">
                <div class="form-group">
                    <label>Mensaje:</label>
                    <textarea name="message" class="form-control" rows="3" name=""></textarea>
                </div>
            </div>
            <div class="col-md-8">
                <div class="form-group">
                ...
                <?php 
                    ...
                    if (isset($_GET['mensaje']) && $_GET['mensaje'] == '3') {
                                    echo '<div class="alert alert-success">
                                                <strong>Muy bien!</strong> has solicitado una cita, en breve nos comunicaremos contigo.
                                            </div>';
                                }
