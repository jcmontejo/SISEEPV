        ...
        <div class="main_container">
            ...
            <div class="right_col" role="main">
                ...
                <?php 
                    if (isset($_GET['mensaje']) && $_GET['mensaje'] == '1') {
                                    ...
                                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                                <strong>Algo esta mal!</strong> no pudo guardarse el evento.
                                            </div>';
                                }
                    if (isset($_GET['mensaje']) && $_GET['mensaje'] == '2') {
                                    echo '<div class="alert alert-info">
                                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                                <strong>Muy bien!</strong> evento guardado exitosamente.
                                            </div>';
                                }
                ...
                <div class="row">
                  <?php 
                    include('conexion.php');
                    $sql = $base->query("SELECT * FROM managment");
                    $datos = $sql->fetch();
                    $managment = $datos['id'];
                 ?>
                    <!--espacio libre-->
                     <div class="col-lg-12">  
                                ...
                                <br>
                                     ...
                                     <input type="hidden" name="managment_id" value="<?php echo $managment; ?>">
                                </div>    
                                <hr>                            
                                <div class="col-md-8">
                                <br>
