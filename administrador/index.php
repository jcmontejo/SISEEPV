                        ...
                        <div class="right">
                            ...
                            <?php 
                                 include('conexion.php');
                                        ...
                                        $user = $base->query('SELECT * FROM user');
                             ?>
                            <div class="count"><?php echo $user->rowCount(); ?></div>
                        </div>
                    </div>
                    <div class="animated flipInY col-md-2 col-sm-4 col-xs-4 tile_stats_count">
                        <div class="left"></div>
                        <div class="right">
                            <span class="count_top"><i class="fa fa-certificate"></i> Egresados Registrados</span>
                            <?php 
                                 include('conexion.php');
                                               /*Realizamos consulta sql*/
                                        $graduate = $base->query('SELECT * FROM graduate');
                             ?>
                            <div class="count"><?php echo $graduate->rowCount(); ?></div>
                        </div>
                    </div>
                    <div class="animated flipInY col-md-2 col-sm-4 col-xs-4 tile_stats_count">
                        <div class="left"></div>
                        <div class="right">
                            <span class="count_top"><i class="fa fa-building"></i> Empresas Registradas</span>
                            <?php 
                                 include('conexion.php');
                                               /*Realizamos consulta sql*/
                                        $company = $base->query('SELECT * FROM company');
                             ?>
                            <div class="count green"><?php echo $company->rowCount(); ?></div>
                        </div>
                    </div>
                    <div class="animated flipInY col-md-2 col-sm-4 col-xs-4 tile_stats_count">
                        <div class="left"></div>
                        <div class="right">
                            <span class="count_top"><i class="fa fa-university"></i> Docentes Registrados</span>
                            <?php 
                                 include('conexion.php');
                                               /*Realizamos consulta sql*/
                                        $docent = $base->query('SELECT * FROM docent');
                             ?>
                            <div class="count"><?php echo $docent->rowCount(); ?></div>
                        </div>
                    </div>
                </div>
                <!-- /top tiles -->
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                                        ...
                                        <div class="profile_img">
                                            ...
                                            <div id="crop-avatar">
                                                ...
                                                <div class="avatar-view" title="Change the avatar">
                                                    <img src="images/admin/cossio.jpg" alt="Avatar">
                                                </div>
                                            </div>
                                            <!-- end of image cropping -->
                                        ...
                                        <ul class="list-unstyled user_data">
                                            <li><i class="fa fa-briefcase user-profile-icon"></i> Jefatura de vinculación
                                            <li class="m-top-xs">
                                                <i class="fa fa-external-link user-profile-icon"></i>
                                                <a href="http://www.siseepv.sistemastectuxtla.net" target="_blank">www.siseepv.sistemastectuxtla.net</a>
                                            </li>
                                        </ul>
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        ...
                                        <div class="profile_title">
                                            <div class="col-md-6">
                                                <h2>Reporte de actividades recientes</h2>
                                            </div>
                                        </div>
                                        <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                            <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                                <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Citas pendientes</a>
                                                </li>
                                                <li role="presentation" class=""><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Empresas registradas</a>
                                                </li>
                                            ...
                                            <div id="myTabContent" class="tab-content">
                                                <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                                                    ...
                                                    <?php 
                                                            include('conexion.php');
                                                               /*Realizamos consulta sql*/
                                                        $resultado = $base->query('SELECT * FROM cita');
                                                        while ($datos = $resultado->fetch()) {
                                                            echo "<li>";
                                                            echo "<div class=\"message_wrapper\">";
                                                            echo "<h4 class=\"heading\">".$datos['name'];
                                                            echo "</h4>";
                                                            echo "<blockquote class=\"message\">".$datos['message'];
                                                            echo "</blockquote>";
                                                            echo "<br />";  
                                                            echo "<p class=\"url\">";
                                                            echo "<span class=\"fs1 text-info\" aria-hidden=\"true\" data-icon=\"\"></span>";
                                                            echo "<a href=\"#\"><i class=\"fa fa-envelope\">&nbsp;&nbsp;".$datos['email'];
                                                            echo "</i></a>";
                                                            echo "</p>";
                                                            echo "</div>";
                                                            echo "</li>";
                                                ...
                                                <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
                                                    ...
                                                    <table class="data table table-striped no-margin">
                                                        ...
                                                        <?php 
                                                            include('conexion.php');
                                                               /*Realizamos consulta sql*/
                                                                $resultado = $base->query('SELECT * FROM company');
                                                                while ($company = $resultado->fetch())
                                                                {
                                                                    echo "tr>";
                                                                    echo "<td>".$company['id'];"</td>";
                                                                    echo "<d>".$company['company_name'];"</td>";
                                                                    echo "<td>".$company['sector'];"</td>";
                                                                    echo "<td class=\"hidden-phone\">".$company['home'];"</td>";
