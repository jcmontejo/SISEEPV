...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'Proyectos por Linea de Investigación'
        },
        tooltip: {
        ...
        series: [{
            ...
            $filasarquitectura = $base->query("SELECT COUNT(*) FROM project WHERE investigation_line = \"Arquitectura de Computadoras\"");
            $arquitectura = $filasarquitectura->fetchColumn();        

            $filasinteligencia = $base->query("SELECT COUNT(*) FROM project WHERE investigation_line = \"Inteligencia Artificial\"");
            $inteligencia = $filasinteligencia->fetchColumn();            

            $filascomputacion = $base->query("SELECT COUNT(*) FROM project WHERE investigation_line = \"Computacion Educativa\""); 
            $computacion = $filascomputacion->fetchColumn();            

            $filastecnologia = $base->query("SELECT COUNT(*) FROM project WHERE investigation_line = \"Tecnologías de Información y Base de Datos\"");
            $tecnologia = $filastecnologia->fetchColumn();            

             ?>  
                ['Arqu. Computadoras', <?php echo $arquitectura; ?>],              
                ['Inteligencia Artif.', <?php echo $inteligencia; ?>],
                ['Comp. Educativa', <?php echo $computacion; ?>],
                ['Tec. Inf. y B.D', <?php echo $tecnologia; ?>]
            ]
        }]
    });
});
...
$(function () {
    $('#container1').highcharts({
        ...
        title: {
            text: 'Proyectos por Producto Obtenido'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
        ...
        series: [{
            ...
            $filasservicio = $base->query("SELECT COUNT(*) FROM project WHERE product_ontends = \"Servicio\"");
            $servicio = $filasservicio->fetchColumn();        

            $filasproducto = $base->query("SELECT COUNT(*) FROM project WHERE product_ontends = \"Producto\"");
            $producto = $filasproducto->fetchColumn();
             ?>  
...
$(function () {
    ...
    $('#container2').highcharts({
        ...
        title: {
            text: 'Proyectos por Tipo de Financiamiento'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
        ...
        series: [{
            ...
            $filaspublico = $base->query("SELECT COUNT(*) FROM project WHERE funding = \"Público\"");
            $publico = $filaspublico->fetchColumn();        

            $filasprivado = $base->query("SELECT COUNT(*) FROM project WHERE funding = \"Privado\"");
            $privado = $filasprivado->fetchColumn();
             ?>  
                ['Publico', <?php echo $publico; ?>],              
                ['Privado', <?php echo $privado; ?>]
            ]
        }]
    });
});
