                                ...
                                <li><a><i class="fa fa-archive"></i> Proyectos <span class="fa fa-chevron-down"></span></a>
                                 ...
                                 <li><a><i class="fa fa-bar-chart"></i> Graficas estadisticas <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
                                        ...
                                        <li>
                                            <a href="graficaempresa.php">Empresas</a>
                                        </li>
                                        <li>
            ...
            <div class="right_col" role="main">
                ...
                <div class="row">
                        ...
                        <div class="col-md-12 col-sm-6 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Proyectos <small>registrados en el sistema.</small></h2>
                                    ...
                                    <table class="table">
                                        ...
                                        <?php 
                                            include('conexion.php');
                                               ...
                                               /*$line = 'Arquitectura de Computadoras';*/
                                        $resultado = $base->query("SELECT * FROM project WHERE investigation_line = \"Tecnologías de Información y Base de Datos\"");
                                        while ($datos = $resultado->fetch()) {
                                            # code...
                                            $tecnologia = $datos['id'];
                                        echo "<tr>";
                                        echo "<th scope=\"row\">".$datos['id'];"</td>";
                                        echo "<td>".$datos['project_name'];"</td>";
                                        echo "<td>".$datos['investigation_line'];"</td>";
                                        echo "<td>".$datos['status'];"</td>";
                                        echo "<td>".$datos['product_ontends'];"</td>";
                                        echo "<td>".$datos['funding'];"</td>";
                                        echo "<td>".$datos['participating_students'];"</td>";
                                        echo "<td><a href=\"bajararchivo.php?var=$tecnologia\"><img src='images/download.png' width='37.' height='37' allingn = \"center\"></a></td>";                                                                            
                                    }
                                         ?>
                                        </tbody>
                                    </table>
