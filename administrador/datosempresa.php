            ...
            <div class="right_col" role="main">
                ...
                <div class="row">
                        ...
                        <div class="col-md-12 col-sm-6 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Solicitudes <small>de vacantes.</small></h2>
                                ...
                                <div class="x_content">
                                    ...
                                    <table class="table">
                                        ...
                                        $resultado = $base->query("SELECT * FROM vacancy_request  WHERE company_id = $id");
                        ...
                        <div class="col-md-12 col-sm-6 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Solicitudes <small>de residentes.</small></h2>
                                ...
                                <div class="x_content">
                                    ...
                                    <table class="table">
                                        ...
                                        if (isset($_GET['empresa'])) {
                                            ...
                                            include('conexion.php');
                                               /*Realizamos consulta sql*/
                                        $resultado = $base->query("SELECT * FROM professional_residence_request  WHERE company_id = $id");
                                        while ($campos = $resultado->fetch()) {
                                            /*# code...
                                            $matri = $datos['matricula'];*/
                                        echo "<tr>";
                        ...
                        <div class="col-md-12 col-sm-6 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Solicitudes <small>para servicio social.</small></h2>
                                ...
                                <div class="x_content">
                                    ...
                                    <table class="table">
                                        ...
                                        if (isset($_GET['empresa'])) {
                                            ...
                                            include('conexion.php');
                                               /*Realizamos consulta sql*/
                                        $resultado = $base->query("SELECT * FROM social_service  WHERE company_id = $id");
                                        while ($campos = $resultado->fetch()) {
                                            /*# code...
                                            $matri = $datos['matricula'];*/
                                        echo "<tr>";
