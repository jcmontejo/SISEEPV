            ...
            <div class="right_col" role="main">
                ...
                <div class="clearfix"></div>
                        <div class="col-md-12 col-sm-6 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Lista de<small> egresados que han realizado la encuesta de <strong>seguimiento</strong> en el sistema.</small></h2>
                                ...
                                <div class="x_content">
                                    ...
                                    <table class="table">
                                        ...
                                        $resultado = $base->query('SELECT graduate. name,last_name,email, test. id FROM graduate INNER JOIN test ON graduate.id = test.graduate_id ORDER BY graduate.last_name');
