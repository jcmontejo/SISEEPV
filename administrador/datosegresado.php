        ...
        <div class="main_container">
            ...
            <div class="right_col" role="main">
                        <?php if (isset($_GET['egresado'])) {
                            ...
                            $name = $datos['name'];
                            /*Realizamos consulta sql*/
                            $personal_data = $base->query("SELECT * FROM personal_data WHERE graduate_id = $egresado");
                            $labor_data = $base->query("SELECT * FROM labor_data WHERE graduate_id = $egresado");
                            $studies_data = $base->query("SELECT * FROM studies_data WHERE graduate_id = $egresado");
                ...
                <div class="row">
                        ...
                        <div class="col-md-12 col-sm-6 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Datos <small>personales.</small></h2>
                                ...
                                <div class="x_content">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                        <?php 
                                        while ($pd = $personal_data->fetch()) 
                                        {
                                            # code...
                                            /*$egresado = $datos['id'];*/
                                        echo "<tr>";
                                        echo "<th scope=\"row\">".$datos['id'];"</td>";
                                        echo "<td>".$pd['curp'];"</td>";
                                        echo "<td>".$pd['sex'];"</td>";
                                        echo "<td>".$pd['birth_date'];"</td>";
                                        echo "<td>".$pd['home'];"</td>";
                                        echo "<td>".$pd['cell'];"</td>";
                                        }
                                         ?>
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                        <?php 
                                        while ($ld = $labor_data->fetch()) 
                                        {
                                            # code...
                                            /*$egresado = $datos['id'];*/
                                        echo "<tr>";
                                        echo "<th scope=\"row\">".$datos['id'];"</td>";
                                        echo "<td>".$ld['name_company'];"</td>";
                                        echo "<td>".$ld['home_company'];"</td>";
                                        echo "<td>".$ld['phone_company'];"</td>";
                                        echo "<td>".$ld['current_position'];"</td>";
                                        echo "<td>".$ld['work_area'];"</td>";
                                        echo "<td>".$ld['salary'];"</td>";
                                        }
                                         ?>
                                        </tbody>
                                    </table>
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                        <?php 
                                        while ($sd = $studies_data->fetch()) 
                                        {
                                            # code...
                                            /*$egresado = $datos['id'];*/
                                        echo "<tr>";
                                        echo "<th scope=\"row\">".$datos['id'];"</td>";
                                        echo "<td>".$sd['admision_day'];"</td>";
                                        echo "<td>".$sd['exit_date'];"</td>";
                                        echo "<td>".$sd['certification'];"</td>";
                                        echo "<td>".$sd['day_certification'];"</td>";
                                        echo "<td>".$sd['certification_method'];"</td>";
                                        echo "<td>".$sd['average'];"</td>";
                                        echo "<td>".$sd['last_grade_student'];"</td>";
                                        echo "<td>".$sd['graduate_institution_name'];"</td>";
                                        }
                                         ?>
                                        </tbody>
                                    </table>
