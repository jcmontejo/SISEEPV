            ...
            <div class="right_col" role="main">
                ...
                <div class="row">
                        ...
                        <div class="col-md-12 col-sm-6 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Empresas <small>registradas en el sistema.</small></h2>
                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <td><strong>Nombre del Director</strong></td>
                                                <td><strong>Contacto con el ITTG</strong></td>
                                                <td><strong>Ver acciones de la Empresa</strong></td>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        <?php 
                                        ...
                                        while ($campos = $resultado->fetch()) {
                                            # code...
                                            $empresa = $campos['id'];
                                        echo "<tr>";
                                        echo "<th scope=\"row\">".$campos['id'];"</td>";
                                        echo "<td>".$campos['company_name'];"<td>";
                                        echo "<td>".$campos['sector'];"<td>";
                                        echo "<td>".$campos['home'];"<td>";
                                        echo "<td>".$campos['phone'];"<td>";
                                        echo "<td>".$campos['director_name'];"<td>";
                                        echo "<td>".$campos['link_with_ittg'];"<td>";
                                        echo "<td><a href=\"datosempresa.php?empresa=$empresa\"><button class='btn btn-round btn-success'>ver</button></a><td>";
                                    }
                                         ?>
                                        </tbody>
                                    </table>
