    ...
    <div class="container body">
        ...
        <div class="main_container">
            ...
            <div class="right_col" role="main">
                ...
                <div class="clearfix"></div>
                    <div class="row">
                        <form action="egresadosperiodo.php" method="POST">
                            <div class="col-md-4">
                        ...
                        <div class="col-md-6">
                            <form action="listaencuesta.php" method="POST">
                                 <div class="form-group">
                                <label><strong>Generar</strong> lista de egresados que han realizado la encuesta de seguimiento</label>
                    ...
                    <br>
                        <div class="col-md-12 col-sm-6 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Todos <small> los egresados registrados en el sistema.</small></h2>
                                ...
                                <div class="x_content">
                                    ...
                                    <table class="table">
                                        ...
                                        $resultado = $base->query('SELECT * FROM graduate');
                                        ...
                                        echo "<td>".$datos['last_name'];"</td>";
                                        echo "<td>".$datos['email'];"</td>";
                                        echo "<td><a href=\"datosegresado.php?egresado=$egresado\"><button type=\"button\" class=\"btn btn-round btn-success\">Ver datos</button></a>
                                             <a href=\"encuestaegresado.php?egresado=$egresado\"><button type=\"button\" class=\"btn btn-round btn-warning\">Ver encuesta</button></a>
                                            </td>";
                                    }
                                         ?>
                                        </tbody>
