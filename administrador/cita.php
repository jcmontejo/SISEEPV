            ...
            <div class="right_col" role="main">
                ...
                <div class="row">
                        ...
                        <div class="col-md-12 col-sm-6 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Listado de <small>citas solicitadas en el sistema.</small></h2>
                                ...
                                <div class="x_content">
                                    ...
                                    <table class="table">
                                        ...
                                        echo "<td>".$datos['message'];"</td>";
                                        echo "<td><a href=\"responder.php?rsp=$nc\" class=\"btn btn-app\">
                ...
                <div class="row">
                     <!-- this row will not appear when printing -->
                                        <div class="row no-print">
                                            <div class="col-xs-12">
                                                <button class="btn btn-default" onclick="window.print();"><i class="fa fa-file-pdf-o"></i> Generar PDF</button>
                                            </div>
                                        </div>
                </div>
