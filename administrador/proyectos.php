                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <table class="table">
                                        ...
                                        $resultado = $base->query('SELECT * FROM project');
                                        ...
                                        echo "<td><a href=\"bajararchivo.php?var=$proyecto\"><img src='images/download.png' width='37.' height='37' allingn = \"center\"></a></td>";                                                                            
                                    }
                                         ?>
                                        </tbody>
                                    </table>
