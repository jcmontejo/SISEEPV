<?php 	
	...
	try{		
		$comprobar = $base->query("SELECT * FROM file_project_pat WHERE project_id = '$project_id'");
		...
		$sql = "INSERT INTO file_project_pat (name, type, size, content, project_id) values ('$name','$type','$size','$content',$project_id)";
