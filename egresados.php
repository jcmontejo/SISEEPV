            ...
            <div class="col-md-4">
                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        ...
                        <p>Por qué a la institución le importas tú te invitamos a responder una encuesta de seguimiento a egresados para saber de nuestros egressdos en el mundo laboral.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        ...
                        <p>Gracias a SISEEPV tendras una mejor comunicación con el Instituto Tecnólogico de Tuxtla Gutiérrez.</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <ul class="list-unstyled">
                                <li><a href="#">Encuesta de segumiento</a>
                                </li>
                                <li><a href="#">Solicitar cita</a>
                                </li>
